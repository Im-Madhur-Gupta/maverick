...
import { AgentStats, Portfolio, Trade } from "@/types/agent";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p
              className={`text-2xl font-bold ${stats?.totalPnL && stats.totalPnL >= 0 ? "text-green-500" : "text-red-500"}`}
            >
              ...
              <tbody>
                {trades.map(trade => (
                  <tr key={trade.id} className="border-t border-gray-700">
                    <td className={`py-4 ${trade.type === "BUY" ? "text-green-500" : "text-red-500"}`}>{trade.type}</td>
