...
export const PERSONA_CONFIGS: Record<AgentPersona, PersonaConfig> = {
  MOON_CHASER: {
    name: "Moon Chaser",
    description: "High-risk, high-reward trader focused on catching explosive price movements and early opportunities.",
    riskTolerance: 9,
    socialWeight: 5,
    technicalWeight: 9,
  ...
  MEME_LORD: {
    name: "Meme Lord",
    description: "Social-driven trader who values viral potential, community engagement, and the dankest of memes.",
    riskTolerance: 7,
    socialWeight: 9,
    technicalWeight: 4,
  ...
  WHALE_WATCHER: {
    name: "Whale Watcher",
    description: "Strategic trader who follows smart money movements and institutional interest for calculated plays.",
    riskTolerance: 5,
    socialWeight: 4,
    technicalWeight: 7,
