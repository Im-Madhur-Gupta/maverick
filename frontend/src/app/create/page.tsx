...
export default function CreateAgent() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // TODO: Call backend to create an agent
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center mb-12">
          <div
            className={`h-1 w-1/2 ${
              step === "persona" ? "bg-blue-500" : "bg-blue-900"
            }`}
          />
          <div
            className={`h-1 w-1/2 ${
              step === "token" ? "bg-blue-500" : "bg-blue-900"
            }`}
          />
        </div>
        ...
        {step === "persona" ? (
          ...
          <div className="max-w-xl mx-auto space-y-8">
            <h2 className="text-2xl font-semibold mb-6">Enter Agent Details</h2>
            <div>
            ...
            {error && (
              <div className="text-red-500 bg-red-900/20 p-4 rounded-xl">
                {error}
              </div>
            )}
